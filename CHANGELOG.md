...
* fix(microapp): add callback for remove microapp (#1534) ([a7aebbd](https://github.com/meanjs/mean/commit/a7aebbd)), closes [#1274](https://github.com/meanjs/mean/issues/1274)
* fix(microapps): MicroApp controllers name conflicts (#1428) ([c96f8c0](https://github.com/meanjs/mean/commit/c96f8c0))
* fix(microapps): MicroApp edit/delete validation ([69b8a05](https://github.com/meanjs/mean/commit/69b8a05)), closes [#1146](https://github.com/meanjs/mean/issues/1146)
* fix(microapps): Orphaned User reference throws server error ([2bdde4e](https://github.com/meanjs/mean/commit/2bdde4e)), closes [#1082](https://github.com/meanjs/mean/issues/1082)
...
* add bootstrap class 'unstyled' to remove bullet points in microapp list ([cb62e46](https://github.com/meanjs/mean/commit/cb62e46))
* add bootstrap class 'unstyled' to remove bullet points in microapp list ([b9d9b61](https://github.com/meanjs/mean/commit/b9d9b61))
...
* Added MicroApp Delete Support ([eeb5423](https://github.com/meanjs/mean/commit/eeb5423))
...
* Adding karma-ng-html2js-preprocessor to fix karma tests.  Adding user mock to microapps tests. ([c468539](https://github.com/meanjs/mean/commit/c468539))
...
* adding proper handling for invalid model ObjectIds passed on to microapp routes ([5bccbdd](https://github.com/meanjs/mean/commit/5bccbdd))
...
* adding test to check proper handling when no microapp exists ([9952138](https://github.com/meanjs/mean/commit/9952138))
...
* Allow Guests to view MicroApps ([cbebed9](https://github.com/meanjs/mean/commit/cbebed9))
...
* MicroApp Cleanup ([c11c428](https://github.com/meanjs/mean/commit/c11c428))
* MicroApps Example Fix ([ccf7eb3](https://github.com/meanjs/mean/commit/ccf7eb3))
* MicroApps Example Fix ([6b0109e](https://github.com/meanjs/mean/commit/6b0109e))
* MicroApps Example Fix ([6598c04](https://github.com/meanjs/mean/commit/6598c04))
* MicroApps Example Fix ([23dc7a3](https://github.com/meanjs/mean/commit/23dc7a3))
...
* Clean up microapp example ([0b3dead](https://github.com/meanjs/mean/commit/0b3dead))
...
* Dummy config directory for the microapps module to make it easier for developers to understand and re ([903b4ca](https://github.com/meanjs/mean/commit/903b4ca))
...
* Fixing microapp and express 4 modification ([5ff49a7](https://github.com/meanjs/mean/commit/5ff49a7))
* Fixing microapps ([38f08ff](https://github.com/meanjs/mean/commit/38f08ff))
* Fixing MicroApps Issues ([f132e10](https://github.com/meanjs/mean/commit/f132e10))
...
* fixing issue #348 - instead of returning a server error 500 on microapp loading which isnt found we'l ([56aff70](https://github.com/meanjs/mean/commit/56aff70))
...
* Fixing style, adding microapp test ([c42c8eb](https://github.com/meanjs/mean/commit/c42c8eb))
...
* Fixing user details exposure in microapps example ([0cfbafa](https://github.com/meanjs/mean/commit/0cfbafa))
...
* More Naming Fixes, microapps cleanup ([edd549d](https://github.com/meanjs/mean/commit/edd549d))
...
* Remove console.log from an microapp test ([a8dae99](https://github.com/meanjs/mean/commit/a8dae99))
...
* Remove ng-init directive from microapp list. ([7770ccc](https://github.com/meanjs/mean/commit/7770ccc))
...
* should return done(err) in microapp server route test ([d00f4ce](https://github.com/meanjs/mean/commit/d00f4ce))
...
* The microapp middleware was calling getErrorMessage with a null argument, causing a crash when this m ([71167b0](https://github.com/meanjs/mean/commit/71167b0))
...
* Update create-microapp.client.view.html ([3949400](https://github.com/meanjs/mean/commit/3949400))
...
* Update form-microapp.client.view.html ([7ffbd3f](https://github.com/meanjs/mean/commit/7ffbd3f))
...
* Use form validation in microapps ([e56c76a](https://github.com/meanjs/mean/commit/e56c76a))
...
* feat(microapps): MicroApp Admin feature (#807) ([89075cb](https://github.com/meanjs/mean/commit/89075cb))
* feat(microapps): MicroAppsService extended $resource (#1266) ([a7370a7](https://github.com/meanjs/mean/commit/a7370a7))
* feat(microapps): Modify microapps module to implement style guidelines. ([b3ad56e](https://github.com/meanjs/mean/commit/b3ad56e)), closes [#874](https://github.com/meanjs/mean/issues/874) [#339](https://github.com/meanjs/mean/issues/339)
* feat(microapps): Rename list.microapps.client.controller.js to list-microapps.client.controller.js ([a014ffc](https://github.com/meanjs/mean/commit/a014ffc)), closes [#1192](https://github.com/meanjs/mean/issues/1192)
...
* BUG: Removed a ng-binding to microapp.content in user-list.client.view.html ([2747df6](https://github.com/meanjs/mean/commit/2747df6))
* formatting: indent ([b8d6fa7](https://github.com/meanjs/mean/commit/b8d6fa7))
* Feature: MicroApp CRUD ops. Added supertests. closes meanjs/mean#92 ([2ec6fa0](https://github.com/meanjs/mean/commit/2ec6fa0)), closes [meanjs/mean#92](https://github.com/meanjs/mean/issues/92)
...
* Merge pull request #890 from lirantal/feature/microapp-module-dummy-config-dir ([bd1a7d7](https://github.com/meanjs/mean/commit/bd1a7d7))
